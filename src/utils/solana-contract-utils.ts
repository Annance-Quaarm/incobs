...
import { McbuseWallets } from '@/types/mcbuse_wallets';
import idl from '@/mcbuse_wallets.json';
...
export class SolanaContractUtils {
  ...
  constructor(dynamicContext: DynamicContext | null) {
  ...
  private async getProgram() {
    ...
    return new anchor.Program(idl as any, this.programId, provider);
  }
